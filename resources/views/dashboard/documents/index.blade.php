                            ...
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <input class="form-control " type="date" id="end_date" name="end_date" placeholder="end_date">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-lg-3 col-form-label">{{__('Notice before expiry')}}</label>
                                        <div class="col-lg-9 col-xl-6">
                                            <input class="form-control " type="number" value="{{ setting('noti_expiry') ?? 30 }}" id="noti_expiry" name="noti_expiry" >
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script>
        $("body").on('click','.delete02',function(){
            if(confirm("هل تريد الحذف فعلا ؟")){
                $.ajax(
        {
