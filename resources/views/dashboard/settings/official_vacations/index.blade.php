...
{{--                    @can('create_nationalities')--}}
                    <a href="{{route('dashboard.official_vacations.create')}}" class="btn btn-brand btn-icon-sm">
...
@push('scripts')
    <script src="{{asset('js/datatables/official_vacations.js')}}" type="text/javascript"></script>
@endpush
