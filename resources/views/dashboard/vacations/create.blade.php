    ...
    <div class="kt-portlet__body kt-portlet__body--fit">
        <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white droid_font" id="kt_contacts_add"
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                ...
                <form action="{{route('dashboard.vacations.store')}}" method="post" class="kt-form"
                                                    ...
                                                    <div class="kt-portlet__body">
                                                        <div class="form-group row ">
                                                            <div class="col-lg-4">
                                                                ...
                                                                <select class="form-control kt-selectpicker"
                                                                    data-val="true" id="vacationTypes"
                                                                    name="vacation_type_id" id="vacation_id">
                                                                    <option value="">
                                                                        {{__('Choose')}}
                                                                    </option>
                                                                    ...
                                                                    <option data-value="{{ (30-$sick_leave_used) }}" data-id='{{ $vacationTypes[0]->id }}'  value="{{$vacationTypes[0]->id}}"> {{$vacationTypes[0]->name()}} </option>
                                                                    @endif

                                                                    @if ($sick_leave_used >= 30)
                                                                    <option data-value="{{ (90-$sick_leave_used) }}" data-id='{{ $vacationTypes[1]->id }}' value="{{$vacationTypes[1]->id}}"> {{$vacationTypes[1]->name()}} </option>
                                                                    @endif

                                                                    @if ($sick_leave_used >= 90)
                                                                    <option data-value="{{ (120-$sick_leave_used) }}" data-id='{{ $vacationTypes[2]->id }}' value="{{$vacationTypes[2]->id}}"> {{$vacationTypes[2]->name()}} </option>
                                                                    @endif


                                                                    @foreach($vacationTypes as $vacationType)
                                                                    @if ($vacationType->id <= 3) 
                                                                
                                                                        @else <option value="{{$vacationType->id}}"
                                                                            data-value="{{$vacationType->num_of_days}}" data-id='{{ $vacationType->id }}'>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <label for="end_date">{{__('Vacation Days')}}<span
                                                                        class="required">*</span></label>
                                                                <div class="input-group date">
                                                                    <input name="vacation_days" type="number"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                @if (auth()->user()->show_advance_payment())
                                                                <div class="row">
                                                                    <label
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                <div
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                                                            <div class="kt-portlet__body text-center">
                                                                                <span class="display-4 available_balance">
                                                                                    {{ $available_balance ?? 0 }}
                                                                                </span>
...
@push('scripts')
<script src="{{asset('js/pages/vacation_request_form.js')}}" type="text/javascript"></script>
@endpush